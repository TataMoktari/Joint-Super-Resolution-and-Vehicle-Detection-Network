...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="/home/mousumi/PycharmProjects/Joint_Optimization_Fine_Tune_DOTA/test/VOC/")
    parser.add_argument("--train_annotation", default="/home/mousumi/PycharmProjects/Joint_Optimization_Fine_Tune_DOTA/data/dataset/voc_train.txt")
    parser.add_argument("--test_annotation",  default="/home/mousumi/PycharmProjects/Joint_Optimization_Fine_Tune_DOTA/data/dataset/voc_test.txt")
